...
import Image3  from "../../../assets/images/trees.jpg"

const Engage = () => {
  return (
    <div className="bg-cover bg-black py-8 bg-center">
        ...
        <div className="flex justify-center space-x-8">
          <div className="w-1/4 h-80 p-4 rounded-md overflow-hidden relative">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
              <h4 className="text-2xl font-bold text-black mb-2 uppercase">ASK A QUESTION</h4>
            </div>
          </div>
          <div className="w-1/4 h-80 p-4 rounded-md overflow-hidden relative">
            <img src={Image2} alt="wildlife" className="w-full h-full rounded-lg object-cover" />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
              <h4 className="text-2xl font-bold mb-2 uppercase">LEAVE AN AMAZING FACT</h4>
            </div>
          </div>
          <div className="w-1/4 h-80 p-4 rounded-md overflow-hidden relative">
            <img src={Image3} alt="wildlife" className="w-full h-full rounded-lg object-cover" />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
              <h4 className="text-2xl font-bold mb-2 uppercase">DONATE</h4>
            </div>
          </div>
        </div>
      </div>
